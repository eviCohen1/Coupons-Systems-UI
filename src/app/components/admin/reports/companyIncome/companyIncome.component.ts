...
import { CompanysIncomeService } from './company.service.service';
...
export class CompanysIncomeComponent implements OnInit {
  ...
  constructor(private srvProduct:CompanysIncomeService, private _router:Router ) {   
  }
